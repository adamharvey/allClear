...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorList = __webpack_require__(3);
	var firebase = __webpack_require__(4);
	var $ = __webpack_require__(8);
	var SlackConfig = __webpack_require__(155);

	var NotLoggedIn = React.createClass({displayName: "NotLoggedIn",
	  render: function() {
	    return (
	...
	var LoggedIn = React.createClass({displayName: "LoggedIn",
	  render: function() {
	    var lists = this.props.that.superList.map(function(list, index)  {
	      return (
	        React.createElement(ListContainer, {parent: this, key: list.newTitle, defaultItem: list.newTitle, firebase: this.props.that.firebaseRef, removeList: this.props.that.removeList.bind(null, list.index), index: list.index})
	      )
	    }.bind(this));

	    return (
	      React.createElement("div", {className: "parallax"}, 
	      React.createElement("div", {className: "parallax-layer parallax-background"}, 
	      React.createElement("div", {className: "water"}
	      )
	      ), 

	      React.createElement("div", {className: "parallax-layer parallax-foreground"}, 
	      React.createElement("div", {className: "headers"}, 
	        React.createElement("img", {className: "logo", src: "logo.png"}), 
	        React.createElement("br", null), 
	        React.createElement("span", {className: "text-block"}, window.count, " issues left")
	      ), 
	      ...
	      React.createElement("div", null, 
	        React.createElement("div", {className: "row"}, 
	          ...
	          React.createElement(SlackConfig, {firebase: this.props.that.firebaseRef})
	        )
	      )
	      )
	      )
	  ...
	  render: function(){
	    ...
	    return (
	      React.createElement("div", null, 
	          ...
	          user == undefined ? ( React.createElement(NotLoggedIn, {that: this}) ) : ( React.createElement(LoggedIn, {that: this}))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var AddItem = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SlackConfig = React.createClass({displayName: "SlackConfig",
	  getInitialState: function() {
	    return {
	      slack: window.slack
	    }
	  ...
	  render: function() {
	    return (
	      ...
	      React.createElement("br", null), 
	      React.createElement("button", {className: "btn btn-primary category-button"}, "Update Slack Webhook")
	      )
	      )
	      )
	      )
